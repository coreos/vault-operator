...
// TODO: refactor createVaultCluster for reusability.
func createVaultCluster(t *testing.T) (*api.VaultService, string, string, map[string]interface{}) {
	f := framework.Global
	...
	return vaultCR, keyPath, initResp.RootToken, secretData
}
...
func TestBackupRestoreOnVault(t *testing.T) {
	...
	vaultCR, keyPath, token, secretData := createVaultCluster(t)
	...
	verifyRestoredVault(t, vaultCR, secretData, keyPath, token)
}
